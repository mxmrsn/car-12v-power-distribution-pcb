...
- Inputs:
  ...
  - `GND` (ground)
- Output (3-pin): `+12V`, `+12V_ACC`, `GND`
- Output (4-pin): `+12V`, `+12V_ACC`, `+12V_HEADLIGHT`, `GND`
...
- 3-pin housing [Molex #0874390300](https://www.digikey.com/en/products/detail/molex/0874390300/561766)
- 4-pin housing [Molex #0874390400](https://www.digikey.com/en/products/detail/molex/0874390400/561767)
